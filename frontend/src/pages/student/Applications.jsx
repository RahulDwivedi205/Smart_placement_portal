      ...
      <div className="space-y-6">
        ...
        <div className="glass-card">
            ...
            <nav className="-mb-px flex space-x-8 px-6">
              {[
                ...
                >
                  ...
                  {tab.count > 0 && (
                    <span className={`${
                      filter === tab.key ? 'bg-blue-400 bg-opacity-30 text-blue-100' : 'bg-white bg-opacity-20 text-blue-200'
          ...
          <div className="divide-y divide-white divide-opacity-20">
            {error && (
              <div className="glass-card bg-red-500 bg-opacity-20 border-red-300 text-red-100 px-4 py-3 rounded-xl m-6">
                {error}
              </div>
            )}
            ...
            {filteredApplications.length > 0 ? (
              filteredApplications.map((application) => (
                <div key={application._id} className="p-6 hover:bg-white hover:bg-opacity-5 transition-colors duration-300">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center mt-2 space-x-4 text-sm text-blue-300">
                    ...
                    <div className="mt-4 pl-16">
                      ...
                      <div className="space-y-2">
                        {application.interviewRounds.map((round, index) => (
                          <div key={index} className="flex items-center justify-between p-3 bg-white bg-opacity-10 rounded-xl backdrop-blur-sm">
                            <div>
                  ...
                  {application.feedback && (
                    <div className="mt-4 pl-16">
                      ...
                      <p className="text-sm text-blue-200 bg-white bg-opacity-10 p-3 rounded-xl backdrop-blur-sm">
                        {application.feedback}
                      </p>
                    </div>
                  )}
